...
public class WebserviceProblemEvent extends ServiceProblemEvent<Boolean> {
    public WebserviceProblemEvent (ControllerConstants.ServiceInterfaceTypes type, ControllerConstants.ServiceInterfaceProblems problemType, Integer problemTry) {
        super(type, problemType, problemTry);
    }
}
